...
def get_standard_stats(year):
    ...
    web = f'https://fbref.com/en/comps/10/{year}/stats/{year}-Championship-Stats'
...
def get_shooting_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/shooting/{year}-Championship-Stats'
...
def get_passing_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/passing/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_gca_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/gca/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_defence_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/defense/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_possession_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/possession/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_playingtime_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/playingtime/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_misc_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/misc/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_goalkeeping_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/keepers/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_advanced_goalkeeping_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/keepersadv/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
def get_pass_type_stats(year):
    web = f'https://fbref.com/en/comps/10/{year}/passing_types/{year}-Championship-Stats'
    print(f"Requesting URL: {web}")
...
if all_data:
    ...
    df_final_sorted.to_csv('all_squad_stats_24-25_Championship.csv', index=False)
