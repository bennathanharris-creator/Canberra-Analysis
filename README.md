...
## Models
In the model 'club_analysis.py' I used entirely SQL queries to get the data I wanted from the dataset and then python to plot bar charts. In 'matchlog_analysis.py' I utilised more styles of analysis, such as line charts and also correlation between wins and certain statistics. I then plotted more line charts based on the results of the correlation using SQL and python.
