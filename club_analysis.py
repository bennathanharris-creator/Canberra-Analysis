...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  7 16:16:40 2025
...
df = pd.read_csv('all_squad_stats_24-25_Championship.csv')

# Load in SQL
conn = sqlite3.connect(':memory:')
df.to_sql('league_stats', conn, index=False, if_exists='replace')

rivals = ['Sheffield Weds', 'Norwich City', 'Watford', 'QPR', 'Portsmouth',
          'Oxford United', 'Stoke City', 'Derby County', 'Preston',
          'Hull City', 'Luton Town']

rivals_sql = "', '".join(rivals)
...
SELECT
    ...
    (SELECT AVG(Goals) FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_goals,
    (SELECT Goals FROM league_stats WHERE Team = 'Oxford United') AS club_goals,
...
rivals_avg = float(season_goals.loc[0, "rivals_avg_goals"])
club_goals = float(season_goals.loc[0, "club_goals"])
top_team = season_goals.loc[0, "top_team"]
top_goals = float(season_goals.loc[0, "top_team_goals"])


teams = ["League Average", "Rivals Average", "Oxford United", top_team]
goals = [league_avg, rivals_avg, club_goals, top_goals]

plt.figure(figsize=(8, 5))
bars = plt.bar(teams, goals, color=["lightgrey", "lightblue", "yellow", "black"], edgecolor="black")
...
SELECT 
    ...
    (SELECT AVG("Non Pen Goals") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_non_pen_goals,
    (SELECT AVG("Pens Scored") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_pens_scored,
    (SELECT AVG("Pens Attempted") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_pens_attempted,
    
    (SELECT "Non Pen Goals" FROM league_stats WHERE Team = 'Oxford United') AS club_non_pen_goals,
    (SELECT "Pens Scored" FROM league_stats WHERE Team = 'Oxford United') AS club_pens_scored,
    (SELECT "Pens Attempted" FROM league_stats WHERE Team = 'Oxford United') AS club_pens_attempted,
...
rivals_avg_npg = float(season_pens.loc[0, "rivals_avg_non_pen_goals"])
rivals_avg_ps = float(season_pens.loc[0, "rivals_avg_pens_scored"])
rivals_avg_pa = float(season_pens.loc[0, "rivals_avg_pens_attempted"])
...
rivals_avg = [rivals_avg_npg, rivals_avg_ps, rivals_avg_pa]
...
bars2 = ax.bar(x - 0.5*width, rivals_avg, width, label='Rivals Avg', color='lightblue')
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_npg}, {top_team_ps}, {top_team_pa})', color='black')
...
SELECT
    ...
    (SELECT AVG("Prog Carries") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_prog_carries,
    (SELECT AVG("Prog Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_prog_passes,
    
    (SELECT "Prog Carries" FROM league_stats WHERE Team = 'Oxford United') AS club_prog_carries,
    (SELECT "Prog Passes" FROM league_stats WHERE Team = 'Oxford United') AS club_prog_passes,
...
rivals_avg_prog_c = float(prog.loc[0, "rivals_avg_prog_carries"])
rivals_avg_prog_p = float(prog.loc[0, "rivals_avg_prog_passes"])
...
rivals_avg = [rivals_avg_prog_c, rivals_avg_prog_p]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_prog_c}, {top_team_prog_p})', color='black')
...
disciplinary_query= f""" 
SELECT
    (SELECT AVG("Yellows") FROM league_stats) AS league_avg_yellows,
    (SELECT AVG("Reds") FROM league_stats) AS league_avg_reds,

    (SELECT AVG("Yellows") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_yellows,
    (SELECT AVG("Reds") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg_reds,
    
    (SELECT "Yellows" FROM league_stats WHERE Team = 'Oxford United') AS club_yellows,
    (SELECT "Reds" FROM league_stats WHERE Team = 'Oxford United') AS club_reds,
...
rivals_avg_yellows = float(disciplinary.loc[0, "rivals_avg_yellows"])
rivals_avg_reds = float(disciplinary.loc[0, "rivals_avg_reds"])
...
rivals_avg = [rivals_avg_yellows, rivals_avg_reds]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_yellows}, {top_team_reds})', color='black')
...
SELECT
    ...
    (SELECT AVG("xG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Non Pen xG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("xAG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Goals minus xG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Non Pen Goals minus Non Pen xG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    
    (SELECT "xG" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Non Pen xG" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "xAG" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Goals minus xG" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Non Pen Goals minus Non Pen xG" FROM league_stats WHERE Team = 'Oxford United') AS club5,
...
rivals_avg_xg = float(xG.loc[0, "rivals_avg1"])
rivals_avg_npxg = float(xG.loc[0, "rivals_avg2"])
rivals_avg_xag = float(xG.loc[0, "rivals_avg3"])
rivals_avg_gmxg = float(xG.loc[0, "rivals_avg4"])
rivals_avg_npgmnpxg = float(xG.loc[0, "rivals_avg5"])
...
rivals_avg = [rivals_avg_xg, rivals_avg_npxg, rivals_avg_xag, rivals_avg_gmxg, rivals_avg_npgmnpxg]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_xg}, {top_team_npxg}, {top_team_xag}, {top_team_gmxg}, {top_team_npgmnpxg})', color='black')
...
SELECT
    ...
    (SELECT AVG("Shots") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Shots on Target") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Shot on Target Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Avg Shot Distance") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    
    (SELECT "Shots" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Shots on Target" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Shot on Target Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Avg Shot Distance" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_s = float(shots.loc[0, "rivals_avg1"])
rivals_avg_sot = float(shots.loc[0, "rivals_avg2"])
rivals_avg_sotp = float(shots.loc[0, "rivals_avg3"])
rivals_avg_asd = float(shots.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_s, rivals_avg_sot, rivals_avg_sotp, rivals_avg_asd]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_s}, {top_team_sot}, {top_team_sotp}, {top_team_asd})', color='black')
...
SELECT
    ...
    (SELECT AVG("Goals per Shot") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Goals per Shot on Target") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    
    (SELECT "Goals per Shot" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Goals per Shot on Target" FROM league_stats WHERE Team = 'Oxford United') AS club2,
...
rivals_avg_gps = float(goals_per_shot.loc[0, "rivals_avg1"])
rivals_avg_gpsot = float(goals_per_shot.loc[0, "rivals_avg2"])
...
rivals_avg = [rivals_avg_gps, rivals_avg_gpsot]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_gps}, {top_team_gpsot})', color='black')
...
SELECT
    ...
    (SELECT AVG("Short Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Medium Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Long Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    
    (SELECT "Short Pass" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Medium Pass" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Long Pass" FROM league_stats WHERE Team = 'Oxford United') AS club5,
...
rivals_avg_sp = float(pass_.loc[0, "rivals_avg1"])
rivals_avg_mp = float(pass_.loc[0, "rivals_avg3"])
rivals_avg_lp = float(pass_.loc[0, "rivals_avg5"])
...
rivals_avg = [rivals_avg_sp, rivals_avg_mp, rivals_avg_lp]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_sp}, {top_team_mp}, {top_team_lp})', color='black')
...
SELECT
    ...
    (SELECT AVG("xA") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Assists minus xAG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    
    (SELECT "xA" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Assists minus xAG" FROM league_stats WHERE Team = 'Oxford United') AS club2,
...
rivals_avg_xa = float(xA.loc[0, "rivals_avg1"])
rivals_avg_amxag = float(xA.loc[0, "rivals_avg2"])
...
rivals_avg = [rivals_avg_xa, rivals_avg_amxag]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_xa}, {top_team_amxag})', color='black')
...
SELECT
    ...
    (SELECT AVG("Key Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Pass into final third") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Pass into Pen Area") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Cross into Pen Area") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    
    (SELECT "Key Passes" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Pass into final third" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Pass into Pen Area" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Cross into Pen Area" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_kp = float(attacking_pass.loc[0, "rivals_avg1"])
rivals_avg_pft = float(attacking_pass.loc[0, "rivals_avg2"])
rivals_avg_ppa = float(attacking_pass.loc[0, "rivals_avg3"])
rivals_avg_cpa = float(attacking_pass.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_kp, rivals_avg_pft, rivals_avg_ppa, rivals_avg_cpa]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_kp}, {top_team_pft}, {top_team_ppa}, {top_team_cpa})', color='black')
...
SELECT
    ...
    (SELECT AVG("Pass Completion") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Short Pass Completion") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Medium Pass Completion") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Long Pass Completion") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    
    (SELECT "Pass Completion" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Short Pass Completion" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Medium Pass Completion" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Long Pass Completion" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_pc = float(pass_completion.loc[0, "rivals_avg1"])
rivals_avg_spc = float(pass_completion.loc[0, "rivals_avg2"])
rivals_avg_mpc = float(pass_completion.loc[0, "rivals_avg3"])
rivals_avg_lpc = float(pass_completion.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_pc, rivals_avg_spc, rivals_avg_mpc, rivals_avg_lpc]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_pc}, {top_team_spc}, {top_team_mpc}, {top_team_lpc})', color='black')
...
SELECT
    ...
    (SELECT AVG("SCA From Live Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("SCA From Dead Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("SCA From Take On") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("SCA From Shot") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("SCA From Foul Drawn") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    (SELECT AVG("SCA From Defensive Action") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg6,

    (SELECT "SCA From Live Pass" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "SCA From Dead Pass" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "SCA From Take On" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "SCA From Shot" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "SCA From Foul Drawn" FROM league_stats WHERE Team = 'Oxford United') AS club5,
    (SELECT "SCA From Defensive Action" FROM league_stats WHERE Team = 'Oxford United') AS club6,
...
rivals_avg_scalp = float(shot_creation.loc[0, "rivals_avg1"])
rivals_avg_scadp = float(shot_creation.loc[0, "rivals_avg2"])
rivals_avg_scato = float(shot_creation.loc[0, "rivals_avg3"])
rivals_avg_scas = float(shot_creation.loc[0, "rivals_avg4"])
rivals_avg_scafd = float(shot_creation.loc[0, "rivals_avg5"])
rivals_avg_scada = float(shot_creation.loc[0, "rivals_avg6"])
...
rivals_avg = [rivals_avg_scalp, rivals_avg_scadp, rivals_avg_scato, rivals_avg_scas, rivals_avg_scafd, rivals_avg_scada]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_scalp}, {top_team_scadp}, {top_team_scato}, {top_team_scas}, {top_team_scafd}, {top_team_scada})', color='black')
...
SELECT
    ...
    (SELECT AVG("GCA From Live Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("GCA From Dead Pass") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("GCA From Take On") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("GCA From Shot") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("GCA From Foul Drawn") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    (SELECT AVG("GCA From Defensive Action") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg6,
    
    (SELECT "GCA From Live Pass" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "GCA From Dead Pass" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "GCA From Take On" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "GCA From Shot" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "GCA From Foul Drawn" FROM league_stats WHERE Team = 'Oxford United') AS club5,
    (SELECT "GCA From Defensive Action" FROM league_stats WHERE Team = 'Oxford United') AS club6,
...
rivals_avg_gcalp = float(goal_creation.loc[0, "rivals_avg1"])
rivals_avg_gcadp = float(goal_creation.loc[0, "rivals_avg2"])
rivals_avg_gcato = float(goal_creation.loc[0, "rivals_avg3"])
rivals_avg_gcas = float(goal_creation.loc[0, "rivals_avg4"])
rivals_avg_gcafd = float(goal_creation.loc[0, "rivals_avg5"])
rivals_avg_gcada = float(goal_creation.loc[0, "rivals_avg6"])
...
rivals_avg = [rivals_avg_gcalp, rivals_avg_gcadp, rivals_avg_gcato, rivals_avg_gcas, rivals_avg_gcafd, rivals_avg_gcada]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_gcalp}, {top_team_gcadp}, {top_team_gcato}, {top_team_gcas}, {top_team_gcafd}, {top_team_gcada})', color='black')
...
SELECT
    ...
    (SELECT AVG("Tackles") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Tackles Won") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Tackles in Def 3rd") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Tackles in Mid 3rd") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Tackles in Att 3rd") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    
    (SELECT "Tackles" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Tackles Won" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Tackles in Def 3rd" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Tackles in Mid 3rd" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Tackles in Att 3rd" FROM league_stats WHERE Team = 'Oxford United') AS club5,
...
rivals_avg_t = float(tackles.loc[0, "rivals_avg1"])
rivals_avg_tw = float(tackles.loc[0, "rivals_avg2"])
rivals_avg_td3 = float(tackles.loc[0, "rivals_avg3"])
rivals_avg_tm3 = float(tackles.loc[0, "rivals_avg4"])
rivals_avg_ta3 = float(tackles.loc[0, "rivals_avg5"])
...
rivals_avg = [rivals_avg_t, rivals_avg_tw, rivals_avg_td3, rivals_avg_tm3, rivals_avg_ta3]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_t}, {top_team_tw}, {top_team_td3}, {top_team_tm3}, {top_team_ta3})', color='black')
...
SELECT
    ...
    (SELECT AVG("Dribblers Tackled") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Dribblers Tackled Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Blocked Shots") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Blocked Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Interceptions") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    (SELECT AVG("Clearances") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg6,
    (SELECT AVG("Recoveries") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg7,
    
    (SELECT "Dribblers Tackled" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Dribblers Tackled Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Blocked Shots" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Blocked Passes" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Interceptions" FROM league_stats WHERE Team = 'Oxford United') AS club5,
    (SELECT "Clearances" FROM league_stats WHERE Team = 'Oxford United') AS club6,
    (SELECT "Recoveries" FROM league_stats WHERE Team = 'Oxford United') AS club7,
...
rivals_avg_dt = float(defensive.loc[0, "rivals_avg1"])
rivals_avg_dtp = float(defensive.loc[0, "rivals_avg2"])
rivals_avg_bs = float(defensive.loc[0, "rivals_avg3"])
rivals_avg_bp = float(defensive.loc[0, "rivals_avg4"])
rivals_avg_i = float(defensive.loc[0, "rivals_avg5"])
rivals_avg_c = float(defensive.loc[0, "rivals_avg6"])
rivals_avg_r = float(defensive.loc[0, "rivals_avg7"])
...
rivals_avg = [rivals_avg_dt, rivals_avg_dtp, rivals_avg_bs, rivals_avg_bp, rivals_avg_i, rivals_avg_c, rivals_avg_r]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_dt}, {top_team_dtp}, {top_team_bs}, {top_team_bp}, {top_team_i}, {top_team_c}, {top_team_r})', color='black')
...
SELECT
    ...
    (SELECT AVG("Touches in Defensive Pen Area") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Touches in Defensive Third") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Touches in Midfield Third") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Touches in Attacking Third") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Touches in Pen Area") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    
    (SELECT "Touches in Defensive Pen Area" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Touches in Defensive Third" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Touches in Midfield Third" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Touches in Attacking Third" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Touches in Pen Area" FROM league_stats WHERE Team = 'Oxford United') AS club5,
...
rivals_avg_todpa = float(touches.loc[0, "rivals_avg1"])
rivals_avg_tod3 = float(touches.loc[0, "rivals_avg2"])
rivals_avg_tom3 = float(touches.loc[0, "rivals_avg3"])
rivals_avg_toa3 = float(touches.loc[0, "rivals_avg4"])
rivals_avg_toapa = float(touches.loc[0, "rivals_avg5"])
...
rivals_avg = [rivals_avg_todpa, rivals_avg_tod3, rivals_avg_tom3, rivals_avg_toa3, rivals_avg_toapa]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_todpa}, {top_team_tod3}, {top_team_tom3}, {top_team_toa3}, {top_team_toapa})', color='black')
...
SELECT
    ...
    (SELECT AVG("Take Ons Attempted") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Take Ons Won") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Take Ons Won Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Take Ons Tackled") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Take Ons Tackled Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    
    (SELECT "Take Ons Attempted" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Take Ons Won" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Take Ons Won Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Take Ons Tackled" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Take Ons Tackled Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club5,
...
rivals_avg_toa = float(take_ons.loc[0, "rivals_avg1"])
rivals_avg_tow = float(take_ons.loc[0, "rivals_avg2"])
rivals_avg_towp = float(take_ons.loc[0, "rivals_avg3"])
rivals_avg_tot = float(take_ons.loc[0, "rivals_avg4"])
rivals_avg_totp = float(take_ons.loc[0, "rivals_avg5"])
...
rivals_avg = [rivals_avg_toa, rivals_avg_tow, rivals_avg_towp, rivals_avg_tot, rivals_avg_totp]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_toa}, {top_team_tow}, {top_team_towp}, {top_team_tot}, {top_team_totp})', color='black')
...
SELECT
    ...
    (SELECT AVG("Carries into Final Third") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Carries into Penalty Area") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    
    (SELECT "Carries into Final Third" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Carries into Penalty Area" FROM league_stats WHERE Team = 'Oxford United') AS club2,
...
rivals_avg_cift = float(carries.loc[0, "rivals_avg1"])
rivals_avg_cipa = float(carries.loc[0, "rivals_avg2"])
...
rivals_avg = [rivals_avg_cift, rivals_avg_cipa]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_cift}, {top_team_cipa})', color='black')
...
SELECT
    ...
    (SELECT AVG("Miscontrols") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Dispossessed") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Errors") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,

    (SELECT "Miscontrols" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Dispossessed" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Errors" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_m = float(mistakes.loc[0, "rivals_avg1"])
rivals_avg_d = float(mistakes.loc[0, "rivals_avg2"])
rivals_avg_e = float(mistakes.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_m, rivals_avg_d, rivals_avg_e]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_m}, {top_team_d}, {top_team_e})', color='black')
...
SELECT
    ...
    (SELECT AVG("Fouls Comitted") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Fouls Drawn") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Offsides") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Fouls Comitted" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Fouls Drawn" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Offsides" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_fc = float(fouls.loc[0, "rivals_avg1"])
rivals_avg_fd = float(fouls.loc[0, "rivals_avg2"])
rivals_avg_o = float(fouls.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_fc, rivals_avg_fd, rivals_avg_o]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_fc}, {top_team_fd}, {top_team_o})', color='black')
...
SELECT
    ...
    (SELECT AVG("Penalties Won") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Penalties Conceded") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Own Goals") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Second Yellows") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,

    (SELECT "Penalties Won" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Penalties Conceded" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Own Goals" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Second Yellows" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_penw = float(misc.loc[0, "rivals_avg1"])
rivals_avg_penc = float(misc.loc[0, "rivals_avg2"])
rivals_avg_og = float(misc.loc[0, "rivals_avg3"])
rivals_avg_sy = float(misc.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_penw, rivals_avg_penc, rivals_avg_og, rivals_avg_sy]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_penw}, {top_team_penc}, {top_team_og}, {top_team_sy})', color='black')
...
SELECT
    ...
    (SELECT AVG("Aerial Duels Won") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Aerial Duels Lost") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Aerial Duels Won Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,

    (SELECT "Aerial Duels Won" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Aerial Duels Lost" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Aerial Duels Won Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_adw = float(aerial.loc[0, "rivals_avg2"])
rivals_avg_adl = float(aerial.loc[0, "rivals_avg3"])
rivals_avg_adwp = float(aerial.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_adw, rivals_avg_adl, rivals_avg_adwp]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_adw}, {top_team_adl}, {top_team_adwp})', color='black')
...
SELECT
    ...
    (SELECT AVG("Goals Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("SoTA") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Saves") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Clean Sheets") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,

    (SELECT "Goals Against" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "SoTA" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Saves" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Clean Sheets" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_ga = float(goalkeeping.loc[0, "rivals_avg1"])
rivals_avg_sota = float(goalkeeping.loc[0, "rivals_avg2"])
rivals_avg_save = float(goalkeeping.loc[0, "rivals_avg3"])
rivals_avg_cs = float(goalkeeping.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_ga, rivals_avg_sota, rivals_avg_save, rivals_avg_cs]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_ga}, {top_team_sota}, {top_team_save}, {top_team_cs})', color='black')
...
SELECT
    ...
    (SELECT AVG("Penalties Faced") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Penalties Scored Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Penalties Saved") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Penalties Missed Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,

    (SELECT "Penalties Faced" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Penalties Scored Against" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Penalties Saved" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Penalties Missed Against" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_pf = float(goalkeeping_pens.loc[0, "rivals_avg1"])
rivals_avg_psa = float(goalkeeping_pens.loc[0, "rivals_avg2"])
rivals_avg_psave = float(goalkeeping_pens.loc[0, "rivals_avg3"])
rivals_avg_pma = float(goalkeeping_pens.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_pf, rivals_avg_psa, rivals_avg_psave, rivals_avg_pma]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_pf}, {top_team_psa}, {top_team_psave}, {top_team_pma})', color='black')
...
SELECT
    ...
    (SELECT AVG("Free Kick Goals Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Corner Goals Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Own Goals Against") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Free Kick Goals Against" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Corner Goals Against" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Own Goals Against" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_fkga = float(goals_against.loc[0, "rivals_avg1"])
rivals_avg_cga = float(goals_against.loc[0, "rivals_avg2"])
rivals_avg_oga = float(goals_against.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_fkga, rivals_avg_cga, rivals_avg_oga]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_fkga}, {top_team_cga}, {top_team_oga})', color='black')
...
SELECT
    ...
    (SELECT AVG("PSxG") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("PSxG per Shot on Target") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("PSxG +/-") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "PSxG" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "PSxG per Shot on Target" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "PSxG +/-" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_psxg = float(PSxG.loc[0, "rivals_avg1"])
rivals_avg_psxgpsot = float(PSxG.loc[0, "rivals_avg2"])
rivals_avg_psxgpom = float(PSxG.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_psxg, rivals_avg_psxgpsot, rivals_avg_psxgpom]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_psxg}, {top_team_psxgpsot}, {top_team_psxgpom})', color='black')
...
SELECT
    ...
    (SELECT AVG("Launches Completed") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Launches Attempted") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Launch Completion Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Launches Completed" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Launches Attempted" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Launch Completion Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_l = float(launches.loc[0, "rivals_avg1"])
rivals_avg_la = float(launches.loc[0, "rivals_avg2"])
rivals_avg_lcp = float(launches.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_l, rivals_avg_la, rivals_avg_lcp]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_l}, {top_team_la}, {top_team_lcp})', color='black')
...
SELECT
    ...
    (SELECT AVG("Goalkeeper Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Goalkeeper Throws") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Launch Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Goalkeeper Avg Pass Length") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,

    (SELECT "Goalkeeper Passes" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Goalkeeper Throws" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Launch Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Goalkeeper Avg Pass Length" FROM league_stats WHERE Team = 'Oxford United') AS club4,
...
rivals_avg_gp = float(goalkeeping_pass.loc[0, "rivals_avg1"])
rivals_avg_gt = float(goalkeeping_pass.loc[0, "rivals_avg2"])
rivals_avg_lap = float(goalkeeping_pass.loc[0, "rivals_avg3"])
rivals_avg_gapl = float(goalkeeping_pass.loc[0, "rivals_avg4"])
...
rivals_avg = [rivals_avg_gp, rivals_avg_gt, rivals_avg_lap, rivals_avg_gapl]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_gp}, {top_team_gt}, {top_team_lap}, {top_team_gapl})', color='black')
...
SELECT
    ...
    (SELECT AVG("Goal Kicks") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Goal Kicks Launched") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Avg Goal Kick Length") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Goal Kicks" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Goal Kicks Launched" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Avg Goal Kick Length" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_gk = float(goal_kicks.loc[0, "rivals_avg1"])
rivals_avg_gkl = float(goal_kicks.loc[0, "rivals_avg2"])
rivals_avg_agkl = float(goal_kicks.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_gk, rivals_avg_gkl, rivals_avg_agkl]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_gk}, {top_team_gkl}, {top_team_agkl})', color='black')
...
SELECT
    ...
    (SELECT AVG("Crosses Faced") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Crosses Stopped") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Crosses Stopped Percentage") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Crosses Faced" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Crosses Stopped" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Crosses Stopped Percentage" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_cf = float(goalkeeper_crosses.loc[0, "rivals_avg1"])
rivals_avg_crs = float(goalkeeper_crosses.loc[0, "rivals_avg2"])
rivals_avg_csp = float(goalkeeper_crosses.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_cf, rivals_avg_crs, rivals_avg_csp]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_cf}, {top_team_crs}, {top_team_csp})', color='black')
...
SELECT
    ...
    (SELECT AVG("Sweeper Actions") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Avg Sweeper Distance") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    
    (SELECT "Sweeper Actions" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Avg Sweeper Distance" FROM league_stats WHERE Team = 'Oxford United') AS club2,
...
rivals_avg_sa = float(sweeper.loc[0, "rivals_avg1"])
rivals_avg_aswd = float(sweeper.loc[0, "rivals_avg2"])
...
rivals_avg = [rivals_avg_sa, rivals_avg_aswd]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_sa}, {top_team_aswd})', color='black')
...
SELECT
    ...
    (SELECT AVG("Live Ball Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Dead Ball Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Crosses") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg6,
    (SELECT AVG("Throw Ins") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg7,

    (SELECT "Live Ball Passes" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Dead Ball Passes" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Crosses" FROM league_stats WHERE Team = 'Oxford United') AS club6,
    (SELECT "Throw Ins" FROM league_stats WHERE Team = 'Oxford United') AS club7,
...
rivals_avg_lbp = float(pass_types.loc[0, "rivals_avg1"])
rivals_avg_dbp = float(pass_types.loc[0, "rivals_avg2"])
rivals_avg_cross = float(pass_types.loc[0, "rivals_avg6"])
rivals_avg_ti = float(pass_types.loc[0, "rivals_avg7"])
...
rivals_avg = [rivals_avg_lbp, rivals_avg_dbp, rivals_avg_cross, rivals_avg_ti]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_lbp}, {top_team_dbp}, {top_team_cross}, {top_team_ti})', color='black')
...
SELECT
    ...
    (SELECT AVG("Free Kick Passes") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    (SELECT AVG("Through Balls") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg4,
    (SELECT AVG("Switches") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg5,
    (SELECT AVG("Corners") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg8,

    (SELECT "Free Kick Passes" FROM league_stats WHERE Team = 'Oxford United') AS club3,
    (SELECT "Through Balls" FROM league_stats WHERE Team = 'Oxford United') AS club4,
    (SELECT "Switches" FROM league_stats WHERE Team = 'Oxford United') AS club5,
    (SELECT "Corners" FROM league_stats WHERE Team = 'Oxford United') AS club8,
...
rivals_avg_fkp = float(pass_types_2.loc[0, "rivals_avg3"])
rivals_avg_tb = float(pass_types_2.loc[0, "rivals_avg4"])
rivals_avg_switch = float(pass_types_2.loc[0, "rivals_avg5"])
rivals_avg_corn = float(pass_types_2.loc[0, "rivals_avg8"])
...
rivals_avg = [rivals_avg_fkp, rivals_avg_tb, rivals_avg_switch, rivals_avg_corn]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_fkp}, {top_team_tb}, {top_team_switch}, {top_team_corn})', color='black')
...
SELECT
    ...
    (SELECT AVG("Inswinging Corners") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Outswinging Corners") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    (SELECT AVG("Straight Corners") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg3,
    
    (SELECT "Inswinging Corners" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Outswinging Corners" FROM league_stats WHERE Team = 'Oxford United') AS club2,
    (SELECT "Straight Corners" FROM league_stats WHERE Team = 'Oxford United') AS club3,
...
rivals_avg_ic = float(corners.loc[0, "rivals_avg1"])
rivals_avg_oc = float(corners.loc[0, "rivals_avg2"])
rivals_avg_sc = float(corners.loc[0, "rivals_avg3"])
...
rivals_avg = [rivals_avg_ic, rivals_avg_oc, rivals_avg_sc]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_ic}, {top_team_oc}, {top_team_sc})', color='black')
...
pass_mistakes_query = f""" 
SELECT
    (SELECT AVG("Passes Offside") FROM league_stats) AS league_avg1,
    (SELECT AVG("Passes Blocked") FROM league_stats) AS league_avg2,
    
    (SELECT AVG("Passes Offside") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg1,
    (SELECT AVG("Passes Blocked") FROM league_stats WHERE Team IN ('{rivals_sql}')) AS rivals_avg2,
    
    (SELECT "Passes Offside" FROM league_stats WHERE Team = 'Oxford United') AS club1,
    (SELECT "Passes Blocked" FROM league_stats WHERE Team = 'Oxford United') AS club2,
...
rivals_avg_po = float(pass_mistakes.loc[0, "rivals_avg1"])
rivals_avg_pb = float(pass_mistakes.loc[0, "rivals_avg2"])
...
rivals_avg = [rivals_avg_po, rivals_avg_pb]
...
bars3 = ax.bar(x + 0.5*width, club, width, label='Oxford United', color='yellow')
bars4 = ax.bar(x + 1.5*width, top_team, width, 
               label=f'Top Teams ({top_team_po}, {top_team_pb})', color='black')
